...
SDL_Window * setupRC(SDL_GLContext &context) {
    ...
    window = SDL_CreateWindow("Lab 4  - Enviroment MApping/Reflection", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
...
void init(void) {
	...
	environmentProgram = rt3d::initShaders("phongEnvMap.vert", "phongEnvMap.frag");
	rt3d::setLight(environmentProgram, light0);
	rt3d::setMaterial(environmentProgram, material0);
	// set light attenuation shader uniforms
	GLuint uniformIndex = glGetUniformLocation(environmentProgram, "attConst");
	glUniform1f(uniformIndex, attConstant);
	uniformIndex = glGetUniformLocation(environmentProgram, "attLinear");
	glUniform1f(uniformIndex, attLinear);
	uniformIndex = glGetUniformLocation(environmentProgram,"attQuadratic");
	...
	uniformIndex = glGetUniformLocation(environmentProgram, "textureUnit1");
	glUniform1i(uniformIndex, 1);
	// set tex sampler to texture unit 0, arbitrarily
	uniformIndex = glGetUniformLocation(environmentProgram, "textureUnit0");
...
void draw(SDL_Window * window) {
	...
	GLuint uniformIndex = glGetUniformLocation(environmentProgram, "cameraPos");
